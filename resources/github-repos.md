...
- [NirDiamant/GenAI_Agents](https://github.com/NirDiamant/GenAI_Agents) — tutorial tổng hợp
- [e2b-dev/awesome-ai-agents](https://github.com/e2b-dev/awesome-ai-agents) — list khổng lồ
...
- [anthropics/anthropic-cookbook](https://github.com/anthropics/anthropic-cookbook) — agent recipe official

## 🧑‍💻 Coding Agents (IDE / CLI)

- [cursor.directory](https://github.com/pontusab/cursor.directory) — Cursor rule community
- [PatrickJS/awesome-cursorrules](https://github.com/PatrickJS/awesome-cursorrules)
- [duongductrong/cursor-kit](https://github.com/duongductrong/cursor-kit) — CLI khởi tạo rule/command/skill
- [hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code)
- [wshobson/agents](https://github.com/wshobson/agents) — Claude Code sub-agents
...
- [joaomdmoura/crewAI-examples](https://github.com/crewAIInc/crewAI-examples)
- [agno-agi/agno](https://github.com/agno-agi/agno) — phenomenal Python framework
- [microsoft/semantic-kernel](https://github.com/microsoft/semantic-kernel)

## 🔌 MCP

- [modelcontextprotocol/specification](https://github.com/modelcontextprotocol/specification)
- [modelcontextprotocol/servers](https://github.com/modelcontextprotocol/servers) — official servers
...
- [letta-ai/letta](https://github.com/letta-ai/letta) — MemGPT
- [mem0ai/mem0](https://github.com/mem0ai/mem0)
- [getzep/zep](https://github.com/getzep/zep)
- [cognitivecomputations/agent-zero-memory](https://github.com/cognitivecomputations/agent-zero) — Agent Zero

## 🛠️ Tools / Sandbox

- [e2b-dev/e2b](https://github.com/e2b-dev/E2B) — code interpreter sandbox
- [OpenInterpreter/open-interpreter](https://github.com/OpenInterpreter/open-interpreter)
- [microsoft/playwright](https://github.com/microsoft/playwright) — browser
- [browser-use/browser-use](https://github.com/browser-use/browser-use)
- [Skyvern-AI/skyvern](https://github.com/Skyvern-AI/skyvern) — browser automation
